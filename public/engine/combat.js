...
class DamageSystem {
  ...
  init() {
    ...
    // W6/W7/W8 melee weapons emit 'damageEntity' — handle it here
    this.eventBus.on('damageEntity', (data) => this._handleDamage(data.entity, data.source, data.damage));
  }
