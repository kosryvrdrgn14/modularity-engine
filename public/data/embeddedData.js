...
const EMBEDDED_DATA = {
  ...
  enemies: [
    ...
    { id: "rat", name: "Rat", type: "normal",
      stats: { hp: 6, damage: 6, speed: 120, size: 7, xpValue: 1, goldValue: 1, goldCoins: { min: 1, max: 1 } },
      behavior: { pattern: "swarm", params: { erraticism: 0.9 } },
      drops: { powerUpTable: [{ type: "magnet", chance: 0.03 }, { type: "pickup_weapon_level_up", chance: 0.01 }] },
      spawn: { weight: 70, firstAppears: "1:30" }
    },
    { id: "brute", name: "Brute", type: "normal",
      stats: { hp: 40, damage: 12, speed: 30, size: 16, xpValue: 5, goldValue: 4, goldCoins: { min: 3, max: 5 } },
      behavior: { pattern: "chase", params: { chaseSpeed: 30 } },
      drops: { powerUpTable: [{ type: "screen_wipe", chance: 0.02 }, { type: "pickup_weapon_level_up", chance: 0.015 }] },
      spawn: { weight: 30, firstAppears: "3:00" }
    },
  ...
  stages: {
    ...
    waves: [
      ...
      { time: "1:30-2:00", enemyTypes: ["zombie", "bat", "rat"], spawnRate: 1.8, compositionWeights: { zombie: 0.40, bat: 0.35, rat: 0.25 }, maxEnemies: 80 },
      ...
      { time: "3:00-3:30", enemyTypes: ["zombie", "bat", "skeleton", "ghost", "caster", "rat", "brute"], spawnRate: 2.5, compositionWeights: { zombie: 0.20, bat: 0.20, skeleton: 0.15, ghost: 0.10, caster: 0.10, rat: 0.15, brute: 0.10 }, maxEnemies: 150 },
      { time: "3:30-4:00", enemyTypes: ["zombie", "bat", "skeleton", "ghost", "caster", "rat", "brute"], spawnRate: 3.0, compositionWeights: { zombie: 0.15, bat: 0.20, skeleton: 0.15, ghost: 0.10, caster: 0.15, rat: 0.15, brute: 0.10 }, maxEnemies: 180 },
